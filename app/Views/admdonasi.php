                ...
                <tbody>
                  ...
                  <?php foreach ($donasi as $d) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= site_url('/admdonasi/editdonasi/' . $d['id_donasi']); ?>"><i class="fas fa-edit text-primary"></i></a> |
                        <a href="<?= site_url('/admdonasi/deletedonasi/' . $d['id_donasi']); ?>" onclick="return confirm('Apakah Anda yakin?');"><i class="fas fa-trash-alt text-danger"></i></a>
                      </td>
                    </tr>
                    <?php
