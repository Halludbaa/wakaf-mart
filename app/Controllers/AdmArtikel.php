...
class AdmArtikel extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($keyword) {
            $artikel =  $this->MdlArtikel->like('judul_artikel', $keyword)
                ->orLike('isi_artikel', $keyword)
                ->paginate(10, 'artikel');
        } else {
            $artikel = $this->MdlArtikel->paginate(10, 'artikel');
        }
        ...
        $data = [
            ...
            'keyword' => $keyword,
            'pager' => $this->MdlArtikel->pager,
            'nomor' => nomor($this->request->getVar('page_artikel'), 10),
        ];
    ...
    public function saveArtikel()
    {
        ...
        if (!$this->validate([
            ...
            'img5' => [
                'rules'  => 'mime_in[img4,image/jpeg,image/pjpeg,image/png,image/x-png]|ext_in[img5,jpg,jpeg,png]',
                'errors' => []
            ],
        ])) {
            return redirect()->to('/admartikel/addartikel')->withInput();
        }
    ...
    public function updateArtikel($id_artikel)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/admartikel/editartikel/' . $id_artikel)->withInput();
        }
        ...
        if ($imgartikel1->getError() == 4) {
            ...
            $imgNama1 = $imgartikel1->getRandomName();
            $imgartikel1->move('front/images/artikel', $imgNama1);
            if ($this->request->getVar('imgLama1') != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $this->request->getVar('imgLama1'))) {
        ...
        if ($imgartikel2->getError() == 4) {
            ...
            $imgNama2 = $imgartikel2->getRandomName();
            $imgartikel2->move('front/images/artikel', $imgNama2);
            if ($this->request->getVar('imgLama2') != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $this->request->getVar('imgLama2'))) {
        ...
        if ($imgartikel3->getError() == 4) {
            ...
            $imgNama3 = $imgartikel3->getRandomName();
            $imgartikel3->move('front/images/artikel', $imgNama3);
            if ($this->request->getVar('imgLama3') != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $this->request->getVar('imgLama3'))) {
        ...
        if ($imgartikel4->getError() == 4) {
            ...
            $imgNama4 = $imgartikel4->getRandomName();
            $imgartikel4->move('front/images/artikel', $imgNama4);
            if ($this->request->getVar('imgLama4') != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $this->request->getVar('imgLama4'))) {
        ...
        if ($imgartikel5->getError() == 4) {
            ...
            $imgNama5 = $imgartikel5->getRandomName();
            $imgartikel5->move('front/images/artikel', $imgNama5);
            if ($this->request->getVar('imgLama5') != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $this->request->getVar('imgLama5'))) {
    ...
    public function deleteArtikel($id_artikel)
    {
        ...
        if ($MdlArtikel['img1'] != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $MdlArtikel['img1'])) {
            unlink('front/images/artikel/' . $MdlArtikel['img1']);
        }

        if ($MdlArtikel['img2'] != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $MdlArtikel['img2'])) {
            unlink('front/images/artikel/' . $MdlArtikel['img2']);
        }

        if ($MdlArtikel['img3'] != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $MdlArtikel['img3'])) {
            unlink('front/images/artikel/' . $MdlArtikel['img3']);
        }

        if ($MdlArtikel['img4'] != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $MdlArtikel['img4'])) {
            unlink('front/images/artikel/' . $MdlArtikel['img4']);
        }

        if ($MdlArtikel['img5'] != 'default.png' && file_exists(FCPATH . 'front/images/artikel/' . $MdlArtikel['img5'])) {
